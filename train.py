...
parser.add_argument('--ground_truth_train_dir', type=str, default='../TecoGAN/data/train/',
                    help='Directory with ground truth training data.')
parser.add_argument('--ground_truth_val_dir', type=str, default='../TecoGAN/data/val/',
                    help='Directory with ground truth validation data.')
parser.add_argument('--tecogan_generated_train_dir', type=str, default='../TecoGAN/data/train/',
                    help='Directory with HR training images generated by TecoGAN.')
parser.add_argument('--tecogan_generated_val_dir', type=str, default='../TecoGAN/data/val/',
